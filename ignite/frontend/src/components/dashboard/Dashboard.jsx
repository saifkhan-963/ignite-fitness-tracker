        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-gray-600 dark:text-gray-300 font-semibold">Workouts This Week</h2>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">
            ...
            <p className="text-4xl font-bold text-orange-500">42.5</p>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">km this week</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">
            ...
            <p className="text-4xl font-bold text-orange-500">3,240</p>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">kcal this week</p>
          </div>
